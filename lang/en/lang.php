...
return [
    ...
    'game' => [
        'new_game' => 'New game',
        'name' => 'Name',
        'name_placeholder' => 'New game name',
        'slug' => 'Slug',
        'slug_placeholder' => 'new-game-slug',
        'image' => 'Image',
        'bgg_id' => 'BoardGameGeek ID',
        'posts' => 'Posts',
        'delete_confirm' => 'Delete this game?',
        'delete_success' => 'Successfully deleted those games.',
        'return_to_games' => 'Return to the blog game list'
    ],
    'menuitem' => [
    ...
    'settings' => [
        ...
        'game_title' => 'Game List',
        'game_description' => 'Displays a list of blog games on the page.',
        'game_slug' => 'Game slug',
        'game_slug_description' => "Look up the blog game using the supplied slug value. This property is used by the default component partial for marking the currently active game.",
        'game_display_empty' => 'Display empty games',
        'game_display_empty_description' => 'Show games that do not have any posts.',
        'game_page' => 'Game page',
        'game_page_description' => 'Name of the game page file for the category links. This property is used by the default component partial.',
        'post_title' => 'Post',
